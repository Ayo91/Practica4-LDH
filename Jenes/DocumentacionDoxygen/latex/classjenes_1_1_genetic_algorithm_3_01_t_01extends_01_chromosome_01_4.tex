...
\begin{DoxyItemize}
\item \hyperlink{enumjenes_1_1_genetic_algorithm_3_01_t_01extends_01_chromosome_01_4_1_1_resize_strategy_ab5fbe0d69a54b0b5286d2231726934e5}{Resize\-Strategy\#\-A\-U\-T\-O}\-: entails the creation of new individuals, generally by cloning. 
\item \hyperlink{enumjenes_1_1_genetic_algorithm_3_01_t_01extends_01_chromosome_01_4_1_1_resize_strategy_a69a9defbff3c22d92a210f7a72646869}{Resize\-Strategy\#\-E\-M\-P\-T\-Y}\-: expands the population, without creating new individuals. 
\item \hyperlink{enumjenes_1_1_genetic_algorithm_3_01_t_01extends_01_chromosome_01_4_1_1_resize_strategy_a2efbc067403542b53491c6ca5d3200fe}{Resize\-Strategy\#\-N\-O\-N\-E}\-: disables the automatic resize of populations. 
\end{DoxyItemize}
...
Terminates the genetic algorithm, notifying the stop event to listeners. It is automatically invoked by the method \hyperlink{classjenes_1_1_genetic_algorithm_3_01_t_01extends_01_chromosome_01_4_a8afdd855dc891b981cbf675c63db72c3}{evolve()}, thus it should not be explicity invoked. \hypertarget{classjenes_1_1_genetic_algorithm_3_01_t_01extends_01_chromosome_01_4_af847a2a8cba2288fbddf726ec12eaf47}{\index{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$@{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$}!to\-String@{to\-String}}
...
The main algorithm sequence \hypertarget{classjenes_1_1_genetic_algorithm_3_01_t_01extends_01_chromosome_01_4_a13cd44ba0fe337e32a545fa925f570c7}{\index{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$@{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$}!current\-Population@{current\-Population}}
\index{current\-Population@{current\-Population}!jenes::GeneticAlgorithm< T extends Chromosome >@{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$}}
...
The generation listeners \hypertarget{classjenes_1_1_genetic_algorithm_3_01_t_01extends_01_chromosome_01_4_a4213a84e54e3d515be8824b4e5c4a70e}{\index{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$@{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$}!history@{history}}
\index{history@{history}!jenes::GeneticAlgorithm< T extends Chromosome >@{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$}}
\subsubsection[{history}]{\setlength{\rightskip}{0pt plus 5cm}Population$<$T$>$ jenes.\-Genetic\-Algorithm$<$ T extends Chromosome $>$.history\mbox{[}$\,$\mbox{]}\hspace{0.3cm}{\ttfamily [private]}}}\label{classjenes_1_1_genetic_algorithm_3_01_t_01extends_01_chromosome_01_4_a4213a84e54e3d515be8824b4e5c4a70e}
\hypertarget{classjenes_1_1_genetic_algorithm_3_01_t_01extends_01_chromosome_01_4_a19813646965d357e4e3526fe6b64a0a4}{\index{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$@{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$}!history\-Size@{history\-Size}}
\index{history\-Size@{history\-Size}!jenes::GeneticAlgorithm< T extends Chromosome >@{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$}}
\subsubsection[{history\-Size}]{\setlength{\rightskip}{0pt plus 5cm}int jenes.\-Genetic\-Algorithm$<$ T extends Chromosome $>$.history\-Size\hspace{0.3cm}{\ttfamily [private]}}}\label{classjenes_1_1_genetic_algorithm_3_01_t_01extends_01_chromosome_01_4_a19813646965d357e4e3526fe6b64a0a4}
...
The minimum history size \hypertarget{classjenes_1_1_genetic_algorithm_3_01_t_01extends_01_chromosome_01_4_a7d361b32fc05b1ad9b2f84b2f8b4a6aa}{\index{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$@{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$}!next\-Population@{next\-Population}}
\index{next\-Population@{next\-Population}!jenes::GeneticAlgorithm< T extends Chromosome >@{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$}}
\subsubsection[{next\-Population}]{\setlength{\rightskip}{0pt plus 5cm}Population$<$T$>$ jenes.\-Genetic\-Algorithm$<$ T extends Chromosome $>$.next\-Population = null\hspace{0.3cm}{\ttfamily [private]}}}\label{classjenes_1_1_genetic_algorithm_3_01_t_01extends_01_chromosome_01_4_a7d361b32fc05b1ad9b2f84b2f8b4a6aa}
\hypertarget{classjenes_1_1_genetic_algorithm_3_01_t_01extends_01_chromosome_01_4_a355d3311ff5b27ae057c3dd06c75e7cd}{\index{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$@{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$}!pool@{pool}}
\index{pool@{pool}!jenes::GeneticAlgorithm< T extends Chromosome >@{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$}}
...
The individuals pool used by populations \hypertarget{classjenes_1_1_genetic_algorithm_3_01_t_01extends_01_chromosome_01_4_a1579283e210144ba90b937be0911a028}{\index{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$@{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$}!random@{random}}
...
The resize strategy used by this genetic algorithm \hypertarget{classjenes_1_1_genetic_algorithm_3_01_t_01extends_01_chromosome_01_4_a9d6056090be623c86c46ad62d37ff164}{\index{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$@{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$}!runner@{runner}}
\index{runner@{runner}!jenes::GeneticAlgorithm< T extends Chromosome >@{jenes\-::\-Genetic\-Algorithm$<$ T extends Chromosome $>$}}
\subsubsection[{runner}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Runner} jenes.\-Genetic\-Algorithm$<$ T extends Chromosome $>$.runner\hspace{0.3cm}{\ttfamily [private]}}}\label{classjenes_1_1_genetic_algorithm_3_01_t_01extends_01_chromosome_01_4_a9d6056090be623c86c46ad62d37ff164}
