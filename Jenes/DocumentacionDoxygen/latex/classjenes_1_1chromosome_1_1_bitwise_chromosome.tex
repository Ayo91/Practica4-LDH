...
\hypertarget{classjenes_1_1chromosome_1_1_bitwise_chromosome_aaa30338501f40d38e67dc23c4f326224}{\index{jenes\-::chromosome\-::\-Bitwise\-Chromosome@{jenes\-::chromosome\-::\-Bitwise\-Chromosome}!bitcross@{bitcross}}
\index{bitcross@{bitcross}!jenes::chromosome::BitwiseChromosome@{jenes\-::chromosome\-::\-Bitwise\-Chromosome}}
\subsubsection[{bitcross}]{\setlength{\rightskip}{0pt plus 5cm}final void jenes.\-chromosome.\-Bitwise\-Chromosome.\-bitcross (
\begin{DoxyParamCaption}
\item[{final int}]{offset, }
\item[{final int}]{index, }
\item[{final {\bf Bitwise\-Chromosome}}]{chromosome, }
\item[{final boolean}]{after}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{classjenes_1_1chromosome_1_1_bitwise_chromosome_aaa30338501f40d38e67dc23c4f326224}
Executes the bit exchange starting from the specified point; it is the start point or the final one according to the after flag value. The cross will involve only the bits of the int value containing the bit at the point position


\begin{DoxyParams}{Parameters}
{\em point} & the cross site \\
\hline
{\em chromosome} & the chromosome to cross with \\
\hline
{\em after} & direction, true for crossing after, false for crossing before the specified point \\
\hline
\end{DoxyParams}
\hypertarget{classjenes_1_1chromosome_1_1_bitwise_chromosome_a4570a4b004cc6e9806ab456e2061086d}{\index{jenes\-::chromosome\-::\-Bitwise\-Chromosome@{jenes\-::chromosome\-::\-Bitwise\-Chromosome}!bitshift@{bitshift}}
\index{bitshift@{bitshift}!jenes::chromosome::BitwiseChromosome@{jenes\-::chromosome\-::\-Bitwise\-Chromosome}}
\subsubsection[{bitshift}]{\setlength{\rightskip}{0pt plus 5cm}final int jenes.\-chromosome.\-Bitwise\-Chromosome.\-bitshift (
\begin{DoxyParamCaption}
\item[{final int}]{index, }
\item[{final int}]{from, }
\item[{final int}]{to, }
\item[{final int}]{bit}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{classjenes_1_1chromosome_1_1_bitwise_chromosome_a4570a4b004cc6e9806ab456e2061086d}
Performs right or left shift in a single integer value


\begin{DoxyParams}{Parameters}
{\em index} & the index of the integer where to perform the shift \\
\hline
{\em from} & the integer start bit position for the shift (in this position wil lbe copied the bit value) \\
\hline
{\em to} & the integer final bit position for the shift \\
\hline
{\em bit} & the bit to insert for execute the round shift \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
the bit value to give at the next integer value 
\end{DoxyReturn}
...
\hypertarget{classjenes_1_1chromosome_1_1_bitwise_chromosome_a7b10180d49ba676325c2387b6e40d395}{\index{jenes\-::chromosome\-::\-Bitwise\-Chromosome@{jenes\-::chromosome\-::\-Bitwise\-Chromosome}!bits@{bits}}
\index{bits@{bits}!jenes::chromosome::BitwiseChromosome@{jenes\-::chromosome\-::\-Bitwise\-Chromosome}}
\subsubsection[{bits}]{\setlength{\rightskip}{0pt plus 5cm}int jenes.\-chromosome.\-Bitwise\-Chromosome.\-bits\hspace{0.3cm}{\ttfamily [private]}}}\label{classjenes_1_1chromosome_1_1_bitwise_chromosome_a7b10180d49ba676325c2387b6e40d395}
\hypertarget{classjenes_1_1chromosome_1_1_bitwise_chromosome_aaca5e98844bcc938fecc81b959a63c03}{\index{jenes\-::chromosome\-::\-Bitwise\-Chromosome@{jenes\-::chromosome\-::\-Bitwise\-Chromosome}!coding@{coding}}
\index{coding@{coding}!jenes::chromosome::BitwiseChromosome@{jenes\-::chromosome\-::\-Bitwise\-Chromosome}}
\subsubsection[{coding}]{\setlength{\rightskip}{0pt plus 5cm}Bit\-Coding jenes.\-chromosome.\-Bitwise\-Chromosome.\-coding\hspace{0.3cm}{\ttfamily [private]}}}\label{classjenes_1_1chromosome_1_1_bitwise_chromosome_aaca5e98844bcc938fecc81b959a63c03}
\hypertarget{classjenes_1_1chromosome_1_1_bitwise_chromosome_a46949d4204ed78a682345d88bb90eb5a}{\index{jenes\-::chromosome\-::\-Bitwise\-Chromosome@{jenes\-::chromosome\-::\-Bitwise\-Chromosome}!genes@{genes}}
\index{genes@{genes}!jenes::chromosome::BitwiseChromosome@{jenes\-::chromosome\-::\-Bitwise\-Chromosome}}
\subsubsection[{genes}]{\setlength{\rightskip}{0pt plus 5cm}int jenes.\-chromosome.\-Bitwise\-Chromosome.\-genes\mbox{[}$\,$\mbox{]}\hspace{0.3cm}{\ttfamily [private]}}}\label{classjenes_1_1chromosome_1_1_bitwise_chromosome_a46949d4204ed78a682345d88bb90eb5a}
\hypertarget{classjenes_1_1chromosome_1_1_bitwise_chromosome_a8270df05321265ad4a7a9345b901aad7}{\index{jenes\-::chromosome\-::\-Bitwise\-Chromosome@{jenes\-::chromosome\-::\-Bitwise\-Chromosome}!load@{load}}
\index{load@{load}!jenes::chromosome::BitwiseChromosome@{jenes\-::chromosome\-::\-Bitwise\-Chromosome}}
\subsubsection[{load}]{\setlength{\rightskip}{0pt plus 5cm}int jenes.\-chromosome.\-Bitwise\-Chromosome.\-load\hspace{0.3cm}{\ttfamily [private]}}}\label{classjenes_1_1chromosome_1_1_bitwise_chromosome_a8270df05321265ad4a7a9345b901aad7}
\hypertarget{classjenes_1_1chromosome_1_1_bitwise_chromosome_a87b8652220ca81cad899a13e341bf954}{\index{jenes\-::chromosome\-::\-Bitwise\-Chromosome@{jenes\-::chromosome\-::\-Bitwise\-Chromosome}!size@{size}}
\index{size@{size}!jenes::chromosome::BitwiseChromosome@{jenes\-::chromosome\-::\-Bitwise\-Chromosome}}
\subsubsection[{size}]{\setlength{\rightskip}{0pt plus 5cm}int jenes.\-chromosome.\-Bitwise\-Chromosome.\-size\hspace{0.3cm}{\ttfamily [private]}}}\label{classjenes_1_1chromosome_1_1_bitwise_chromosome_a87b8652220ca81cad899a13e341bf954}
\hypertarget{classjenes_1_1chromosome_1_1_bitwise_chromosome_ab7a20df94261bb660cadcfb834012f1f}{\index{jenes\-::chromosome\-::\-Bitwise\-Chromosome@{jenes\-::chromosome\-::\-Bitwise\-Chromosome}!slots@{slots}}
\index{slots@{slots}!jenes::chromosome::BitwiseChromosome@{jenes\-::chromosome\-::\-Bitwise\-Chromosome}}
\subsubsection[{slots}]{\setlength{\rightskip}{0pt plus 5cm}int jenes.\-chromosome.\-Bitwise\-Chromosome.\-slots\hspace{0.3cm}{\ttfamily [private]}}}\label{classjenes_1_1chromosome_1_1_bitwise_chromosome_ab7a20df94261bb660cadcfb834012f1f}
